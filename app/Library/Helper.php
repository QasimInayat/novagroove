...
function trialExpiry(){
    ...
    if($diff > 0){
        ...
        return '<small style="color:white">Your trial has been ended.</small>';
    }
}
function subscriptionExpiry(){
    ...
    if(!empty($transactions)){
        ...
        if($diff > 0){
            ...
            return '<small style="color:white">Your Subscription has been ended. <a style="color:white" href='.url("user/accounts/renew-plan").'>Please Subscribe</a></small>';
        }
    }
}
