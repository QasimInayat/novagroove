...
<div class="content-wrapper">
  ...
  <div class="row d-flex">
    <div class="col-lg-4 grid-margin stretch-card rounded d-flex flex-column justify-content-center align-items-center text-center" style="border: 1px  solidwhite;">
    ...
    <div class="mt-5  mb-5 col-lg-6 ">
      ...
      <a href="{{route('user.banks.create')}}" class="btn btn-lg btn-dark" style="background-color:white; color: #333;;">Add New Bank</a>
    </div>
    @endif
  </div>
  @if(isset($bank) && !empty($bank) && !empty($bank->id))
  <div class="row ">
    <div class="col-12 col-md-6 col-lg-4 grid-margin">
      <div class="card">
        ...
        <div class="card-body">
          <h4 class="card-title"><span style="color: white;">Account</span> Information</h4>
          ...
          <h4 class="card-title mt-4"><span style="color: white;">Bank </span> Information</h4>
