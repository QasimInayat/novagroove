...
<div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3>Hi, <span style="color: white;">liamgareth</span></h3>
            </div>
        </div>
                    ...
                    <section class="section__FAQS">
                        ...
                        <div class="faq_section">
                            <div class="faq-container">
                                <h2 style="color:white;">{{isset($value->title) && !empty($value->title) ? ucfirst($value->title) : '-'}}</h2>
                                @if(!empty($value->faqs))
                                ...
                                <div class="faq @if($i == 0) active @endif">
                                    ...
                                    <button class="faq-toggle" style="background: white">
