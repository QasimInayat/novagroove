...
<div class="content-wrapper">
    <div class="row">
        <div class="container-fluid d-flex justify-content-between align-items-center p-2 mb-3">
            <div class="row mb-4 w-100">
                <div class="col-md-6">
                    <h1 class="h1 ">Hi, <span class="user" style="color: white;">@auth{{Auth::user()->name}}@endauth</span></h1>
                </div>
                <div class="col-md-6 text-left text-md-right">
                    <a href="{{route('user.release.create')}}" class="btn btn-lg" style="background-color:white; color: #333;">Create
                        Release</a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin  ">
            <div class="card-credit rounded text-center pt-4 pb-4" style="border: 1px  solidwhite;">
                <h2 class="h2">
                    <span>Credit Balance</span>
                    <span>${{currentStatus(auth()->user()->id)}}</span>
                </h2> <br>
                <div class="payout">
                    <a href="{{route('user.payout.payout')}}" class="btn  btn-lg btn-dark" style="background-color:white; color: #333;;">Pay
                        out</a>
                </div>
            </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                    <center><span style="background:white; color:black; padding:5px">Song Analytics Unavailable Because This Is A New Account</span></center>
                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3 d-none">
                            <div class="d-flex justify-content-center">
                                <span class="badge rounded-circle p-4" style=" background-color: white;color:black">${{$store_count}}</span>
                            </div>
                        </div>
