            ...
            <div class="card-body py-4 px-lg-4 px-2">
               ...
               <div class="">
                ...
                <div class="" id="addMainPrimaryArtist">
                    <br>
                    <button  onClick="mainArtist($(this))" data-type="main" data-location="release" type="button"  class="btn " style="background-color: white; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Main Primary Artist</strong></button>
                </div>
                ...
                <div class="mb-2 mt-2" id="addOtherKeyArtist" style="display: none">
                    <button  onClick="mainArtist($(this))" data-type="other" data-location="release"  type="button"  class="btn " style="background-color: white; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Other Key Artist</strong></button>
                </div>
              ...
              <div class="d-md-flex justify-content-between gap-3">
               ...
               <div class="mb-lg-4 mb-3">
                  ...
                  <div class="stories mt-2 border p-3 pb-0">
                     ...
                     <span class="mx-2 mb-3 d-inline-block @if($item->name != 'Spotify') showTimes  @endif storeDetails_{{ $item->id }}"  data-id="{{ $item->id }}"><a href="javascript:;" @if($item->name != 'Spotify') onClick="removeStore({{$item->id}})" @endif id="store_{{ $item->id }}" style="color:white"><img src="{{asset('assets/icons/'.$item->logo)}}" width="45" height="45" alt="{{ $item->name }}"></a></span>
                     @empty
                     @endforelse
                  </div>
               </div>
                ...
                <div id="track_1">
                    <div class="card-body py-4 px-lg-4 px-2">
                        ...
                        <div class="" id="addMainPrimaryArtistTrack">
                            <br>
                            <button  onClick="mainArtist($(this))" data-type="main" data-location="track" type="button"  class="btn " style="background-color: white; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Main Primary Artist</strong></button>
                        </div>
                        ...
                        <div class="mb-2 mt-2" id="addOtherKeyArtistTrack" style="display: none">
                            <button  onClick="mainArtist($(this))" data-type="other" data-location="track" type="button"  class="btn " style="background-color: white; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Other Key Artist</strong></button>
                        </div>
                    </div>
            ...
            <div class="card-body border-top">
               ...
               <div class="row">
                    <div class="col-12 text-end">
                        <div id="createMode">
                            <a href="#multiTracks">
                                <button type="button" id="addTrack" data-id="1" onClick="uploadTrack($(this))" class="btn btn-primary rounded">Add Track</button>
                            </a>
                        </div>
