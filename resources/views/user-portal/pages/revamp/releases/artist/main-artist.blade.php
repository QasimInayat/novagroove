...
<div class="col-md-4 border border-primary artist_remove" style="border-color:white !important; border-radius: 8px;" id="artist_{{$artist->id}}">
    <div class="row p-2">
        <div class="col-2">
        ...
        <div class="col-4" >
            <div style="float:right">
                @if(!empty($artist->spotify_profile_link))
                    <a href="javascript:;" onClick="editArtist({{ $artist->id }},'main')">
                ...
                @endif
                <a href="javascript:;" onClick="deleteArtist($(this),'main','{{$artist->id}}','{{ $location }}')">
