...
<div class="col-md-12 text-center">
    <div>
        ...
        <p class="tag">For General Inquiries and Support</p>
    </div>
</div>
@endpush
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-lg-4 mb-3">
                                    ...
                                    <input type="number" name="contact" id="contact" value="{{old('contact')}}" placeholder="Contact Number" required class="form-control custom-control">
