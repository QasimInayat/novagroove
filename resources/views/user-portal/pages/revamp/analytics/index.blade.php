    ...
    <div class="col-12">
        <div class="card @if($analytics == false) p-3 @endif">
            <div class="card-body">
                ...
                @else
                <center><span style="background:white; color:black; padding:5px">Song Analytics Unavailable of {{ request('last_days') ? request('last_days') : 'Last 7 Days' }}.</span></center>
                @endif
...
<div class="row px-lg-4 px-0 mt-4">
    <div class="col-12">
        <h2 class="section-heading">Streams By Number</h2>
    </div>
</div>
...
<section class="streames">
    ...
    <div class="row px-lg-4 px-0 mt-4">
        <div class="col-12">
            <h2 class="section-heading">Streams By Countries</h2>
        </div>
    </div>
                        ...
                        <table class="table px-4 mb-0 home-table">
                            ...
                            <tr>
                                <td colspan="2" class="text-center">
                                    <br>
                                    <center><span style="background:white; color:black; padding:1px">No record found</span></center>
                                    <br>
                                </td>
                            </tr>
                            @endforelse
...
<div class="row px-lg-4 px-0 mt-4">
    <div class="col-12">
        <h2 class="section-heading">Streams By Revenue</h2>
    </div>
</div>
            ...
            @if($count <= 4)
                ...
                <div class="card stream-card">
                    <div class="card-body py-5">
                        ...
                        <p class="mt-4">{{number_format($value)}} Streams</p>
                    </div>
                </div>
                @endif
            @php $count++; @endphp
            @empty
                <center><span style="background:white; color:black; padding:5px">No record found</span></center>
