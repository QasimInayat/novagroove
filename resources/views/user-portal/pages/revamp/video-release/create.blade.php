...
<div class="row mt-2 px-lg-4">
   ...
   <div class="col-12">
      {!! Form::open(['route' => 'user.video-release.store', 'id' => 'form', 'enctype' => 'multipart/form-data']) !!}
      ...
      <div class="auth-form">
         <div class="card">
            <div class="card-body py-4 px-lg-4 px-2">
               ...
               <div class="mb-lg-4 mb-3">
                  ...
                  <input type="text" name="video_title" id="alTitle" required placeholder="Video Title" class="form-control custom-control">
               </div>
               <div class="mb-lg-4 mb-3">
                <label for="" class="form-label">Do you have a Vevo channel?</label>
                <div class="form-check ">
                    <input class="form-check-input me-3" name="vevo"type="radio" id="flexRadioDefault1" value="yes" onchange="vevoLink($(this))">
                    <label class="form-check-label" for="flexRadioDefault1">
                    <span class="custom-label">Yes</span>

                    </label>
                </div>
                <div class="mb-lg-4 mb-3" id="vevoLink" style="display:none">
                    <input type="text" name="vevo_link" id="vevo_link"  placeholder="Insert Link" class="form-control custom-control">
                 </div>
                <div class="form-check ">
                    <input class="form-check-input me-3" name="vevo" type="radio" value="no"  id="flexRadioDefault2" checked onchange="vevoLink($(this))">
               ...
               <div class="mb-lg-4 mb-3">
                ...
                <div class="form-check ">
                    <input class="form-check-input me-3" name="is_video_made_for_kids" type="radio" id="flexRadioDefault11" value="yes" >
                    <label class="form-check-label" for="flexRadioDefault11">
                    <span class="custom-label">Yes</span>
                    </label>
                </div>
                <div class="form-check ">
                    <input class="form-check-input me-3" name="is_video_made_for_kids" type="radio" value="no"  id="flexRadioDefault22" checked >
               ...
               <div class="mb-lg-4 mb-3">
                ...
                <div class="form-check ">
                    <input class="form-check-input me-3" name="youtube" type="radio" id="flexRadioDefault10" value="yes" onchange="youtubeLink($(this))">
                    <label class="form-check-label" for="flexRadioDefault10">
                    <span class="custom-label">Yes</span>

                    </label>
                </div>
                <div class="mb-lg-4 mb-3" id="youtubeLink" style="display:none">
                    <input type="text" name="youtube_link" id="youtube_link"  placeholder="Insert Link" class="form-control custom-control">
                 </div>
                <div class="form-check ">
                    <input class="form-check-input me-3" name="youtube" type="radio" value="no"  id="flexRadioDefault20" checked onchange="youtubeLink($(this))">
            ...
            <div class="d-md-flex justify-content-between gap-3">
                <div class="mb-lg-4 mb-3 w-100 position-relative input-icon">
                    ...
                    <select id="exampleFormControlSelect2" name="primary_language" required class="form-control custom-control">
             ...
             <div class="mb-lg-4 mb-3 w-100 position-relative input-icon">
                ...
                <input type="text"  name="label_copyright" id="label"  required placeholder="Label & Copyright" class="form-control custom-control">
             </div>
            </div>
            <div class="d-md-flex justify-content-between gap-3">
               ...
               <div class="mb-lg-4 mb-3 w-100 position-relative input-icon">
                ...
                <input type="text" id="isrc" name="isrc_code" placeholder="If you don’t have one. Leave blank we’ll generate one for free" class="form-control custom-control">
            </div>
        </div>
        ...
        <div class="mb-lg-4 mb-3">
            ...
            <textarea placeholder="Video Description" class="form-control custom-control h-auto" rows="4"  name="video_description" id="video_description"> </textarea>
        ...
        <div class="mb-lg-4 mb-3 input-icon position-relative" id="lyricsSection">
         ...
         <div>
           ...
           <div class="image-album" style="display:none ;">
             ...
             <img id="uploadedImage" src="#" alt="Uploaded Image" accept="image/png, image/jpeg" style="display:none; height:150px; width:250px" class="img-upload-album">
          </div>

           <input type="file" id="readUrl" name="video_thumbnail" required accept="image/*"  class="form-control custom-control">
           <img id="uploadedImage" src="#" alt="Uploaded Image" accept="image/png, image/jpeg" style="display:none; height:100px; width:100px;">
            ...
            <div class="mb-lg-4 mb-3 input-icon position-relative" id="aTrack">
                <div class="col-lg-12">
                   ...
                   <input type="hidden" id="video_track" name="video_track" required>
                </div>
                <div class="col-lg-12">
                   <div class="row p-3 pb-4 border border-light rounded shadow m-0">
                      <!-- Default checked -->
                      ...
                      <div class="col-md-12">
                         <div class="file-upload-wrapper" id="zdrop">
                           ...
                           <small style="display: none" class="showloaderMsg"></small>
                         </div>
                      </div>
                   </div>
                </div>
         ...
         <div class="mb-lg-4 mb-3">
            ...
            <div class="form-check  mt-4">
               ...
               I accept that I can only upload video that is music.
               </label>
         ...
         <span class="ins d-block mt-4 mb-lg-4 mb-3">Add your Video track this button will be enable on your  upload.</span>
         <div class="row">
            <div class="col-12 ">
               <button id="createRelease" type="submit" class="btn btn-primary rounded w-100" disabled>Create Video Release</button>
            </div>
         </div>
