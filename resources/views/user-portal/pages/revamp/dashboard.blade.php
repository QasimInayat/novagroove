...
<div class="row">
    <div class="col-md-12 text-center">
       <span style="background:white; color:black; padding:5px; font-size:11px">Dashboard Upgrade Ongoing. Some Features Might Be Paused.</span>
    </div>
</div>
@endif
    ...
    <div class="col-12">
        <div class="card @if($analytics == false) p-3 @endif">
            <div class="card-body">
                ...
                @else
                <center><span style="background:white; color:black; padding:5px; font-size:11px">Song Analytics Unavailable for {{ request('last_days') ? request('last_days') : 'Last 7 Days' }}.</span></center>
                @endif
