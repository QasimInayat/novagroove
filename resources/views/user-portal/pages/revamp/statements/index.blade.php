                    ...
                    <table id="example" class="datatables-basic table">
                        ...
                        @foreach($records as $index=>$value)
                            ...
                            <tr>
                                ...
                                <td class="py-4">{{isset($value->release_date) && !empty($value->release_date) ? getDateFormat($value->release_date)  : '-'}}</td>
                                <td class="py-4">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                @forelse(statementExcel($value->id) as $index=>$file)
                                                                    <tr>
                                                                        <td>{{++$index}}</td>
                                                                        <td ><a href="{{asset(config('upload_path.csv') . $file->file)}}" style="color:white">{{$file->file}}</a></td>
                                                                        <td>
