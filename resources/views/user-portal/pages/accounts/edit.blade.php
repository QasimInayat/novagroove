...
<div class="content-wrapper">
    <div class="row">
        <div class="container-fluid d-flex  align-items-center p-2">
            <h1 class="h1 mb-2 mt-2"> <span class="user" style="color: white;">My Account</span>
            </h1><br>
    ...
    <div class="row mb-5">
        <div class="col-12">
            ...
            <a class="btn btn-lg mt-3" href="{{route('user.accounts.renewplans')}}" style="background-color:white; color:#333;">Renew Now</a>
        </div>
    </div>
    @if($errors->any())
    ...
    <div class="container-fluid bg-gray-dark p-5">
        ...
        <form action="{{route('user.accounts.updatePassword')}}" class="setting__account" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        <button type="submit" class="btn btn-lg" style="background-color:white; color:#333;">Update Password</button>
                    </div>
                </div>
            </div>
        </form>
