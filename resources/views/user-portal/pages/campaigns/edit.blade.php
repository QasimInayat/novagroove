...
<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-2">
            <a class="btn btn-lg" href="{{route('user.campaigns.index')}}" style="background-color:white; color: #333;;">View All Campaigns</a>
        </div>
        <div class="col-lg-12">
        ...
        <div class="container-fluid">
            <form action="{{route('user.campaigns.update' , $edit->id)}}" id="form__campaign" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 style="color: white;">What Are You Promoting</h3>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group d-flex">
                            <div class="form-check" style="margin-right:10px ;">
                                <label class="form-check-label" style="color: #fff;">
                                    <input type="checkbox" class="form-check-input" @if($edit->is_single == 1) checked @endif style="border:1px solid white !important ;" name="is_single"> Single </label>
                                @error("is_single") <span class="text-danger">{{$message}}</span> @enderror
                            </div>

                            <div class="form-check">
                                <label class="form-check-label" style="color: #fff;">
                                    <input type="checkbox" class="form-check-input" @if($edit->is_mixtape == 1) checked @endif style="border:1px solid white !important ;" name="is_mixtape"> EP/Mixtape
                                </label>
                            ...
                            <div class="form-check" style="margin-left: 10px;">
                                <label class="form-check-label" style="color: #fff;">
                                    <input type="checkbox" class="form-check-input" @if($edit->is_album == 1) checked @endif style="border:1px solid white !important ;" name="is_album"> Album </label>
