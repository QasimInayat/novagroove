                        ...
                        <div class="form-group d-flex">
                            <div class="form-check" style="margin-right:10px ;">
                                <label class="form-check-label" style="color: #fff;">
                                    <input type="checkbox" class="form-check-input" style="border:1px solid white !important ;" name="is_single"> Single </label>
                                @error("is_single") <span class="text-danger">{{$message}}</span> @enderror
                            </div>

                            <div class="form-check">
                                <label class="form-check-label" style="color: #fff;">
                                    <input type="checkbox" class="form-check-input" style="border:1px solid white !important ;" name="is_mixtape"> EP/Mixtape
                                </label>
                            ...
                            <div class="form-check" style="margin-left: 10px;">
                                <label class="form-check-label" style="color: #fff;">
                                    <input type="checkbox" class="form-check-input" style="border:1px solid white !important ;" name="is_album"> Album </label>
