...
<div class="content-wrapper">
   <div class="row">
      <div class="col-lg-12">
         <h2 class="text-center" style="color: white;">Edit Release</h2>
      </div>
   </div>
    ...
    <div id="track_{{$index + 1}}"  >
        ...
        <div class="row bg-dark " id="addTrackContent_0" style="padding-right:17px; padding-left:17px;">
           ...
           <div class="col-12 text-right mt-3 mb-3">
              <button type="button" id="" data-id="{{$index + 1}}" class="btn btn-lg" onClick="uploadTrack({{$index + 1}})" style="background-color: white; color: #333;">Add Track</button>
           </div>
        </div>
...
<div class="row mt-5 bg-dark p-3 mb-5">
   ...
   <div class="col-lg-12 mt-4">
      <button type="submit" class="btn btn-block btn-lg" id="createRelease"
         style="background-color:white; color: #333;" >Update
      Release</button>
   </div>
</div>
<!-- Modal -->
