...
<div class="" id="addMainPrimaryArtistTrack" @if(count($artistIds) > 0) style="display: none;" @endif><br><button onclick="mainArtist($(this))" data-type="main" data-location="track" type="button" class="btn " style="background-color: white; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Main Primary Artist</strong></button></div>
<div id="mainArtistDetailTrack">
 @forelse($artistIds as $rma)
    ...
    @if($rAelectedArtist->type == 'main')
        ...
        <div class="col-md-4 border border-primary artist_remove" style="border-color:white !important; border-radius: 8px;" id="artist_{{$rma}}">
            <div class="row p-2">
                <div class="col-2">
                    <img src="{{asset('assets/portal-revamp/img/svg/profile-picture-placeholder.svg')}}" width="50">
                </div>
                <div class="col-6 text-left">
                    <h5 style="color:white">{{ $rAelectedArtist->name }}</h5>
                    <small style="color:white">{{ ucwords($rAelectedArtist->role) }} Artist</small>
                </div>
                <div class="col-4">
