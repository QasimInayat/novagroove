...
<div class="content-wrapper">
   <div class="row">
      <div class="col-lg-12">
         <h2 class="text-center" style="color: white;">Create Release</h2>
      </div>
   </div>
...
<div class="row bg-dark " id="aTrack" style="padding-right:17px; padding-left:17px;">
          ...
          <div class="col-md-12">
             <div class="file-upload-wrapper">
                ...
                <div class="card card-body w-100 ">
                   <audio controls src="" id="audio_1" width="100%" style="background:white; display:none"></audio>
                </div>
    ...
    <div class="col-12 text-right mt-3 mb-3">
       <button type="button" id="addTrack" data-id="1" class="btn btn-lg" onClick="uploadTrack($(this))" style="background-color: white; color: #333;">Add Track</button>
    </div>
 </div>
<div class="row mt-5 bg-dark p-3 mb-5">
   ...
   <div class="col-lg-12 mt-4">
      ...
      <button type="submit" class="btn btn-block btn-lg" id="createRelease" style="background-color:white; color: #333;" disabled>Create
         Release</button>
   </div>
</div>
<!-- Modal -->
