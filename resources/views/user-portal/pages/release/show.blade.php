...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="h1 mb-4 mt-2 d-inline-block mr-3"><a href="{{route('user.release.index')}}"><i class="mdi mdi-keyboard-return"></i></a>{{$release->album_title}} <small class="user" style="color: white;">(No. of Songs - {{count(json_decode($release->track_ids))}})</small></h1>
            {{--  <a href="{{route('user.release.edit',$release->id)}}" class="btn btn-sm" style="background-color: white; color: #333;">Edit Details</a>  --}}
