   ...
   <div class="row">
      <div class="container-fluid d-flex align-items-center p-2">
         <div class="row mb-4 w-100">
            <div class="col-md-6">
               <h1 class="h1  mt-2">Welcome, <span class="user" style="color: white;">{{auth()->user()->name}}</span></h1>
               @if(auth()->user()->is_subscribed != 1){!! trialExpiry() !!} @else {!! subscriptionExpiry() !!} @endif
            </div>
            <div class="col-md-6 text-left text-md-right">
               <a href="{{route('user.release.create')}}" class="btn btn-lg text-dark" style="background-color:white;">Create
                  Release</a>
            </div>
         </div>
      </div>
