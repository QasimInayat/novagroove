    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 mx-auto">
                ...
                <p class="mt-5">Novagroove is the world’s leading music distribution and marketing company. Rated as the best music distribution agency by top media & entertainment publications such as Los Angeles Weekly & The Source Magazine, Novagroove has been at the forefront in offering independent artists & labels major record label services such as music distribution, playlist promotion, music pr services & creative marketing campaigns in the press.</p>

                <p>Novagroove has had massive success where their current & previous artists have charted on the Billboard Hot 100 & Hot 200, featured on Clash Magazine, LA Weekly and Complex Magazine while also amassing hundreds of millions of streams on major streaming platforms such as Spotify, Tidal & Apple Music.</p>

                <p>In 2021 alone, over 50 artists affiliated to Novagroove earned over One Million Dollars In Royalties with hundreds earning over $50,000 in royalties during the same period.</p>
...
<section class="tiers">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="font-oswald text-color-primary mb-4">The Three Tiers of Novagroove</h2>
            </div>
            ...
            <div class="col-md-4 mb-md-0 mb-4">
                <div class="tiers-grid">
                    ...
                    <p>We offer music promotion campaigns for talented artists across all genres globally. Other distributors offer distribution services alone; however, Novagroove offers music distribution & marketing at no additional cost in any package you pick. We have a reputation for creative marketing and music publicity campaigns. Our artists have been featured on major blogs such as Complex, Billboard, Notion Magazine & more</p>
                </div>
            </div>
            ...
            <div class="col-md-8 mx-auto">
                <div class="why-details">
                    ...
                    <p class="text-white mt-4">
                        Basically, Novagroove makes releasing, marketing and managing music smoother and easier than ever, used by hundreds of thousands of artists – from Manila to New York. Unlike the old record labels, we work to make things as easy as can be, through our smart services, in order to boost artists independance.
                    </p>
                </div>
            </div>
        </div>
