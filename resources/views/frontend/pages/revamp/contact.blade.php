...
<section class="faqs-main-headign">
    <div class="container custom-container">
        <div class="row">
            <div class="col-12">
                <div class="our-work">
                    <h1 class="font-oswald text-color-primary mb-5">Get In Touch</h1>

                    <p class=" text-white  mb-3">For general enquiries only. If you have a support issue for an existing release, please log into your account and contact us from the member area.</p>
                </div>
            </div>
        </div>
    </div>
