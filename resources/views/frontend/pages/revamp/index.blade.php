                    ...
                    <div class="col-md-6">
                        <div class="music-market-right">
                            <h3 class="text-white font-oswald mb-5">RELEASING MUSIC WITH <span
                                    class="text-color-primary">Novagroove</span> IS FAST AND EASY</h3>

                            <h3 class="text-white font-oswald">WE PROMOTE EVERY SONG RELEASED UNDER <span
                                    class="text-color-primary">Novagroove</span> FOR <span
                                    class="text-color-primary">FREE</span> ON THE PRESS, SPOTIFY & SOCIAL MEDIA
                            </h3>

                            <p class=" mt-5">Novagroove Distro has been at the forefront in offering independent
                            ...
                            <p class="mb-5 mt-4">In 2021 alone, over 50 artists affiliated to Novagroove Distro
...
<section class="why-choose text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="font-oswald text-white">WHY CHOOSE Novagroove DISTRO</h1>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4 col-sm-6  mb-3">
                <div class="why-details">
                    ...
                    <p class="mt-4">Novagroove Distro offers headline-grabbing music publicity campaigns for
            ...
            <div class="col-md-4 col-sm-6 mb-md-0 mb-3">
                <div class="why-details">
                    ...
                    <p class="mt-4">Novagroove Distro works with hundreds of influencers on Instagram that will
            ...
            <div class="col-lg-7 mx-auto">
                <div class="testimonial-slider">
                    <div class="test-slide text-center">
                        ...
                        <p class="text">“Novagroove is so easy to use. The reports are very detailed and they promoted all my release on the press including billboards and rolling Stones”</p>
