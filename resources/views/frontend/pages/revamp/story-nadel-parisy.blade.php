    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-3">
                ...
                <p> Nadel Paris’s success came after a partnership with <mark class="" style="background-color: rgba(0, 0, 0, 0); color:white"><span><strong>Sharpline Distro</strong></span></mark><strong>, with whom the artist had collaborated in the past.
