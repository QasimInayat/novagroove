               ...
               <div class="ghostkit-grid-inner">
                  <div class="ghostkit-col ghostkit-col-lg-12 ghostkit-col-10">
                     <div class="ghostkit-col-content">
                        ...
                        <h2 class="ghostkit-custom-YVi2R" style="font-size: 70px;">Molly Hammar</h2>

                     </div>
                  </div>
               </div>
            </div>
            <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/molly.jpg')}}" alt="" class="wp-image-632" width="1140" height="641" srcset="{{asset('images/molly.jpg')}}" sizes="(max-width: 1140px) 100vw, 1140px"></figure>
...
<center>
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/molly2.jpg')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/molly2.jpg')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
...
<center>
    ...
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/molly-spotify.jpg')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/molly-spotify.jpg')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
</center>
