               ...
               <div class="ghostkit-grid-inner">
                  <div class="ghostkit-col ghostkit-col-lg-12 ghostkit-col-10">
                     <div class="ghostkit-col-content">
                        ...
                        <h2 class="ghostkit-custom-YVi2R" style="font-size: 70px;">Femme</h2>

                     </div>
                  </div>
               </div>
            </div>
            <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/femme.jpg')}}" alt="" class="wp-image-632" width="1140" height="641" srcset="{{asset('images/femme.jpg')}}" sizes="(max-width: 1140px) 100vw, 1140px"></figure>


<h2 class="ghostkit-custom-1KwqTs has-large-font-size">The Plan:</h2>
<p >The initial brief for FEMME’s marketing campaign was to find premiere partners for each track on her ‘Covers’ EP. <b>Sharpline Distro</b> were taken on, on a full time basis, with the plan to broaden FEMME out of the smaller and niche areas she was popular online already, reaching new and bigger audiences, while always keeping things very…FEMME…stylish, sexy, kitsch, fun, pop. </p>
<center>
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/femme2.jpg')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/femme2.jpg')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
...
<center>
    ...
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/femme-spotify.jpg')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/femme-spotify.jpg')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
</center>
