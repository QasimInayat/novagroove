               ...
               <div class="ghostkit-grid-inner">
                  <div class="ghostkit-col ghostkit-col-lg-12 ghostkit-col-10">
                     <div class="ghostkit-col-content">
                        ...
                        <h2 class="ghostkit-custom-YVi2R" style="font-size: 70px;">Icy Lando Featuring Sean Kingston</h2>

                     </div>
                  </div>
               </div>
            </div>
            <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/icy-lando.jpg')}}" alt="" class="wp-image-632" width="1140" height="641" srcset="{{asset('images/icy-lando.jpg')}}" sizes="(max-width: 1140px) 100vw, 1140px"></figure>
...
<center>
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/rollingout.jpg')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/rollingout.jpg')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
...
<center>
    ...
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/icy-lando2.png')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/icy-lando2.png')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
</center>
...
<center>
    ...
    <figure class="wp-block-image size-large is-resized"><img loading="lazy" src="{{asset('images/icy-lando-spotify.jpg')}}" alt="" class="wp-image-632" width="500" height="641" srcset="{{asset('images/icy-lando-spotify.jpg')}}" sizes="(max-width: 500px) 100vw, 500px"></figure>
</center>
