       ...
       <div class="auth">
          <div class="row">
             <div class="col-md-12 text-center">
                <a href="{{url('/')}}"><img src="{{asset('images/logoSharpline.png')}}" alt="" style=" height:120px;"></a>
             </div>
                ...
                <div class="auth-form">
                    {!! Form::open(['route' => 'login', 'id' => 'form']) !!}
                      ...
                      <div class=" position-relative input-icon">
                         ...
                         <i onclick="showPassword()" id="passIcon1" class="fa-solid fa-eye" style="color:white"></i>
                      </div>
