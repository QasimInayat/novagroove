                ...
                <div class="card-body p-0">
                    ...
                    <div class="py-4 px-lg-4 px-2 border-bottom">
                        <div class="release-data">
                            ...
                            <p class="mb-2">
                                <span class="badge bg-default" style="background:white !important;"><a href="{{ route('admin.release.VideoalbumArtWork',$release->video_thumbnail) }}" style="color:black;text-decoration:none">Download Video Thumbnail</a></span>
                              </p>
                            <div class="col-12">
                        ...
                        <div class="release-data mt-3">
                            ...
                            <p class="mb-2">
                                <span class="badge bg-default" style="background:white !important;"><a href="{{ route('admin.release.VideodownloadTrack',$release->video_track) }}" style="color:black;text-decoration:none">Download Video </a></span>
                              </p>
                            <div class="col-12">
