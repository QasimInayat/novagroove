                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="release_date" class="form-control" id="" placeholder="Contact">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="pdf" accept="application/pdf" id="" placeholder="Contact">
